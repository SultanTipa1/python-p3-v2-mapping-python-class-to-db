...
print(payroll) # <Department None: Payroll, uilding A, 5th Floor>

payroll.save() # Persist to db, assign oject id attribute
...
payroll.delete() # delete from db table, object still exist in memory
print(payroll) #<Department 1: Payroll, Building A, 5th Floor>
